...
class LanguageManager(BaseModel):
    ...
    translation_schemas: Dict[LanguageCode, TranslationSchema] = Field(default_factory=dict)
    ...
    @staticmethod 
    def from_dict(*, language_code: LanguageCode, translations: Dict[str, Any]) -> "LanguageManager":
        ...
        return LanguageManager(
            ...
            translation_schemas=translation_schemas
        )
    
    def get_translations(self, language_code: Optional[LanguageCode] = None) -> TranslationSchema:
    ...
    def get_translation(self, key_path: str, language_code: Optional[LanguageCode] = None) -> str:
        ...
        return _navigate_translation_path(
            translation_object=translation_schema,
            key_path=key_path
        )
...
def _load_translation_file(*, language_code: LanguageCode) -> Optional[TranslationSchema]:
    ...
    try:
        with open(translation_file_path, "r", encoding='utf-8') as yaml_file:
